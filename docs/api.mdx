...
You can look up refunds for a specific bundle by using the [flashbots_getFeeRefundsByBundle](https://docs.flashbots.net/flashbots-auction/advanced/rpc-endpoint#flashbots_getfeerefundsbybundle) API.
